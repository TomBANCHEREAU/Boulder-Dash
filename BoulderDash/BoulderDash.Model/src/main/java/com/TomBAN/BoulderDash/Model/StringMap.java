...
public class StringMap {
	...
	private void setDiamondNeeded(int diamondNeeded) {
		if(diamondNeeded<0) {
			throw new RuntimeException("The player count of the map cannot be less than 0 : " + diamondNeeded + " ! >= 0");
		}
		// TODO
		// TODO
	...
	private void setPlayerCount(int playerCount) {
		if(playerCount<=0) {
			throw new RuntimeException("The player count of the map cannot be less or equals than 0 : " + playerCount + " ! > 0");
		}
		// TODO
		// TODO
